...
import server.ServerConfigUtil;
...
public class ProduitController implements Serializable {
    ...
    public void save() throws IOException {
        System.out.println("ana f save produit..."+fileUploadEvents.size());
        System.out.println("ana f save Produit .... " + selected);
    ...
    public String findPath(Produit produit) {
        System.out.println("aaaaaaaaaaaaaa " + produit.getPhoto());
        try {
            String s = ServerConfigUtil.getChaumagePath(produit, true);
            System.out.println("ssss ?file=" + s + "/" + produit.getPhoto());
            return s + "/" + produit.getPhoto();
        } catch (Exception e) {
            return "makayn walo";
        }
    }
